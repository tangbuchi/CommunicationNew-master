...
namespace Communication_Net45.Test.Documentation.Samples.Profinet
{
    public class SiemensS7ServerExample
    {
        ...
        {
            Console.WriteLine(Communication.BasicFramework.SoftBasic.ByteToHexString(data, ' ')); // 打印客户端发送的数据
        }
