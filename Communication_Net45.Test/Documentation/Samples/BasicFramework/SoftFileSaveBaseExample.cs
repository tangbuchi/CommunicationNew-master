...
namespace Communication_Net45.Test.Documentation.Samples.BasicFramework
{
    ...
    /// </summary>
    public class SoftSettings : Communication.BasicFramework.SoftFileSaveBase
    {
        /// <summary>
    ...
    /// </summary>
    public class SoftSettings2 : Communication.BasicFramework.SoftFileSaveBase
    {
        /// <summary>
        /// 必须重写这个方法，返回的数据就真正保存到txt的数据
        /// </summary>
        ...
        {
            // 采用了des加密存储了数据
            base.SaveToFile( m => Communication.BasicFramework.SoftSecurity.MD5Encrypt( m, "12345678" ) );
        }

        public override void LoadByFile( )
        {
            // 采用了des加密解密了数据
            base.LoadByFile( m => Communication.BasicFramework.SoftSecurity.MD5Decrypt( m, "12345678" ) );
        }
