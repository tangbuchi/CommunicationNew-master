...
namespace Communication_Net45.Test.Profinet.Melsec
{
    ...
    public class MelsecFxLinksTest
    {
        ...
        public void buildCommandTest( )
        {
            ...
            Assert.IsTrue( Communication.BasicFramework.SoftBasic.IsTwoBytesEquel( command.Content, right ), Communication.BasicFramework.SoftBasic.ByteToHexString( command.Content, ' ') );
        }
