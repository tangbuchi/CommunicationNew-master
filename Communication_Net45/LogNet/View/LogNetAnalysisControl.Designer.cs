namespace Communication.LogNet
{
    partial class LogNetAnalysisControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.userButton_source = new Communication.Controls.UserButton();
            this.userButton_All = new Communication.Controls.UserButton();
            this.userButton_Fatal = new Communication.Controls.UserButton();
            this.userButton_Error = new Communication.Controls.UserButton();
            this.userButton_Warn = new Communication.Controls.UserButton();
            this.userButton_Info = new Communication.Controls.UserButton();
            this.userButton_Debug = new Communication.Controls.UserButton();
