...
namespace Communication.BasicFramework
{
    /// <summary>
    /// 一个软件基础类，提供常用的一些静态方法 ->
    ...
    public class SoftBasic
    {
        ...
        /// <code lang="cs" source="Communication_Net45.Test\Documentation\Samples\BasicFramework\SoftBasicExample.cs" region="ByteToHexStringExample1" title="ByteToHexString示例" />
        /// </example>
        public static string ByteToHexTenString(byte[] InBytes)
        {
            return ByteToHexTenString(InBytes, (char)0);
        }
        ...
        /// <code lang="cs" source="Communication_Net45.Test\Documentation\Samples\BasicFramework\SoftBasicExample.cs" region="ByteToHexStringExample2" title="ByteToHexString示例" />
        /// </example>
        public static string ByteToHexTenString(byte[] InBytes, char segment)
        {
            StringBuilder sb = new StringBuilder();
            foreach (byte InByte in InBytes)
            {
                if (segment == 0) sb.Append(string.Format("{0}", InByte));
                else sb.Append(string.Format("{0}{1}", InByte, segment));
            }
        ...
        /// </remarks>
        public static SystemVersion FrameworkVersion { get; set; } = new SystemVersion("6.2.5");
