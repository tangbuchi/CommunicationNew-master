...
namespace Communication.Algorithms.ConnectPool
{
    /// <summary>
    ...
    public class ConnectPool<TConnector> where TConnector : IConnector
    {
        ...
        public ConnectPool( Func<TConnector> createConnector )
        {
            ...
            hybirdLock = new Communication.Core.SimpleHybirdLock( );
        ...
        private Communication.Core.SimpleHybirdLock hybirdLock = null;  // 列表操作的锁
