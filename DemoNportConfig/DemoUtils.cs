...
namespace DemoNportConfig
{
    ...
    public class DemoUtils
    {
        ...
        public static void BulkReadRenderResult( Communication.Core.IReadWriteNet readWrite, TextBox addTextBox, TextBox lengthTextBox, TextBox resultTextBox )
        {
            try
            {
                ...
                if (read.IsSuccess)
                {
                    resultTextBox.Text = "Result：" + Communication.BasicFramework.SoftBasic.ByteToHexString( read.Content );
                }
                else
                {
