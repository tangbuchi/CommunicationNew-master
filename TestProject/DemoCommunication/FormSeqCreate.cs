...
namespace CommunicationDemo
{
    ...
    public partial class FormSeqCreate : Form
    {
        ...
        private Communication.BasicFramework.SoftNumericalOrder softNumericalOrder;    // 序列号生成器对象

        private void FormSeqCreate_Load( object sender, EventArgs e )
        {
            softNumericalOrder = new Communication.BasicFramework.SoftNumericalOrder(
