...
namespace CommunicationDemo.Algorithms
{
    public partial class FormConnectPool : Form
    {
        ...
        private void FormConnectPool_Load( object sender, EventArgs e )
        {
            ...
            siemensConnect = new Communication.Algorithms.ConnectPool.ConnectPool<SiemensConnector>( ( ) => { return new SiemensConnector( "192.168.1.195" ); } );
        ...
        private Communication.Algorithms.ConnectPool.ConnectPool<SiemensConnector> siemensConnect = null;           // 西门子对象的连接池
    ...
    public class SiemensConnector : Communication.Algorithms.ConnectPool.IConnector
    {
        #region 构造方法

        public SiemensConnector( string ipAddress )
        {
            siemens = new Communication.Profinet.Siemens.SiemensS7Net( Communication.Profinet.Siemens.SiemensPLCS.S1200, ipAddress );
        }
        ...
        /// </summary>
        /// <returns></returns>
        public Communication.Profinet.Siemens.SiemensS7Net GetSiemens( )
        {
            return siemens;
        }
        ...
        private Communication.Profinet.Siemens.SiemensS7Net siemens;        // 连接对象
