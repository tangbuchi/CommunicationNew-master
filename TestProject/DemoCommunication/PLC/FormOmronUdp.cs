...
namespace CommunicationDemo
{
    public partial class FormOmronUdp : Form
    {
        ...
        private void button1_Click( object sender, EventArgs e )
        {
            ...
            omronFinsUdp.ByteTransform.DataFormat = (Communication.Core.DataFormat)comboBox1.SelectedItem;
        ...
        {
            OperateResult<byte[]> read = omronFinsUdp.ReadFromCoreServer( Communication.BasicFramework.SoftBasic.HexStringToBytes( textBox13.Text ) );
            if (read.IsSuccess)
            {
