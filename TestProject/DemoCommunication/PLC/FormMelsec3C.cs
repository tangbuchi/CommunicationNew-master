...
namespace CommunicationDemo
{
    public partial class FormMelsec3C : Form
    {
        ...
        {
            OperateResult<byte[]> read = melsecA3C.ReadBase( Communication.BasicFramework.SoftBasic.HexStringToBytes( textBox13.Text ) );
            if (read.IsSuccess)
            {
        ...
        private void test6()
        {
            ...
            melsecA3C.LogNet = new Communication.LogNet.LogNetSingle( Application.StartupPath + "\\Logs.txt" );
        }
