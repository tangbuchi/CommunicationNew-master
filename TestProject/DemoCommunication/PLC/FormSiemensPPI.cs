...
namespace CommunicationDemo
{
    public partial class FormSiemensPPI : Form
    {
        ...
        {
            // Clipboard.SetText( Communication.BasicFramework.SoftBasic.ByteToHexString( SiemensPPI.BuildReadCommand( 2, textBox3.Text, 1, true ).Content, ' ' ) );
            // 读取bool变量
        ...
        {
            // bool写入
            //MessageBox.Show( Communication.BasicFramework.SoftBasic.ByteToHexString( SiemensPPI.BuildWriteCommand( siemensPPI.Station, textBox8.Text, new byte[] { 1 } ).Content, ' ' ) );
            //return;
            try
            {
        ...
        {
            // Clipboard.SetText( Communication.BasicFramework.SoftBasic.ByteToHexString( SiemensPPI.BuildWriteCommand( 2, textBox8.Text, new byte[] { 0x12, 0x34 } ).Content, ' ' ) );
        ...
        private void Test2( )
        {
            ...
            Communication.Core.IByteTransform ByteTransform = new Communication.Core.ReverseBytesTransform( );
