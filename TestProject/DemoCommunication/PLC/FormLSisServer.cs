...
namespace CommunicationDemo
{
    public partial class FormLSisServer : Form
    {
        ...
        private Communication.Profinet.LSIS.LSisServer lSisServer;
        ...
        private void button1_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                ...
                lSisServer = new Communication.Profinet.LSIS.LSisServer( );                       // 实例化对象
                //lSisServer.LogNet = new Communication.LogNet.LogNetSingle( "logs.txt" );                  // 配置日志信息
        ...
        private void button4_Click( object sender, EventArgs e )
        {
            ...
            using (FormInputAlien form = new FormInputAlien( ))
            {
                ...
                {
                    OperateResult connect = lSisServer.ConnectAlientClient( form.IpAddress, form.Port, form.DTU );
