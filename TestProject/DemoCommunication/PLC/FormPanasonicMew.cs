...
using Communication;
using Communication.Profinet.Panasonic;
...
namespace CommunicationDemo
{
    public partial class FormPanasonicMew : Form
    {
        ...
        private void button26_Click( object sender, EventArgs e )
        {
            try
            {
                OperateResult<byte[]> read = panasonicMewtocol.ReadBase( Communication.Serial.SoftCRC16.CRC16(Communication.BasicFramework.SoftBasic.HexStringToBytes( textBox13.Text )) );
                if (read.IsSuccess)
                {
