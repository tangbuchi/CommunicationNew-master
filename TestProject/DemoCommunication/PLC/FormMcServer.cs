...
namespace CommunicationDemo
{
    public partial class FormMcServer : Form
    {
        ...
        private Communication.Profinet.Melsec.MelsecMcServer mcNetServer;
        ...
        private void button1_Click( object sender, EventArgs e )
        {
            ...
            try
            {
                ...
                mcNetServer = new Communication.Profinet.Melsec.MelsecMcServer( );                       // 实例化对象
        ...
        private void button4_Click( object sender, EventArgs e )
        {
            ...
            using (FormInputAlien form = new FormInputAlien( ))
            {
                ...
                {
                    OperateResult connect = mcNetServer.ConnectAlientClient( form.IpAddress, form.Port, form.DTU );
