...
namespace CommunicationDemo
{
    public partial class FormMelsecLinks : Form
    {
        ...
        {
            OperateResult<byte[]> read = melsecSerial.ReadBase( Communication.BasicFramework.SoftBasic.HexStringToBytes( textBox13.Text ) );
            if (read.IsSuccess)
            {
        ...
        private void test6( )
        {
            ...
            melsecSerial.LogNet = new Communication.LogNet.LogNetSingle( Application.StartupPath + "\\Logs.txt" );
