...
namespace CommunicationDemo
{
    public partial class FormPanasonicBinary : Form
    {
        ...
        {
            OperateResult<byte[]> read = panasonic_net.ReadFromCoreServer( Communication.BasicFramework.SoftBasic.HexStringToBytes( textBox13.Text ) );
            if (read.IsSuccess)
            {
        ...
        private void test6( )
        {
            ...
            panasonic_net.LogNet = new Communication.LogNet.LogNetSingle( Application.StartupPath + "\\Logs.txt" );
        }
