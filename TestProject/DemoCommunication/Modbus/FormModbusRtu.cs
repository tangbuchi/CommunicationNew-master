    ...
    public partial class FormModbusRtu : Form
    {
        ...
        private void ComboBox2_SelectedIndexChanged( object sender, EventArgs e )
        {
            if (busRtuClient != null)
            {
                ...
                {
                    case 0: busRtuClient.DataFormat = Communication.Core.DataFormat.ABCD; break;
                    case 1: busRtuClient.DataFormat = Communication.Core.DataFormat.BADC; break;
                    case 2: busRtuClient.DataFormat = Communication.Core.DataFormat.CDAB; break;
                    case 3: busRtuClient.DataFormat = Communication.Core.DataFormat.DCBA; break;
                    default: break;
                }
            }
        }
        ...
        {
            OperateResult<byte[]> read = busRtuClient.ReadBase( Communication.Serial.SoftCRC16.CRC16( Communication.BasicFramework.SoftBasic.HexStringToBytes( textBox13.Text ) ) );
            if (read.IsSuccess)
            {
