    ...
    public partial class FormModbusAscii : Form
    {
        ...
        private void ComboBox2_SelectedIndexChanged( object sender, EventArgs e )
        {
            if (busAsciiClient != null)
            {
                ...
                {
                    case 0: busAsciiClient.DataFormat = Communication.Core.DataFormat.ABCD; break;
                    case 1: busAsciiClient.DataFormat = Communication.Core.DataFormat.BADC; break;
                    case 2: busAsciiClient.DataFormat = Communication.Core.DataFormat.CDAB; break;
                    case 3: busAsciiClient.DataFormat = Communication.Core.DataFormat.DCBA; break;
                    default: break;
                }
            }
        }
        ...
        {
            OperateResult<byte[]> read = busAsciiClient.ReadBase( Communication.Serial.SoftCRC16.CRC16( Communication.BasicFramework.SoftBasic.HexStringToBytes( textBox13.Text ) ) );
            if (read.IsSuccess)
            {
