    ...
    public partial class FormServer : Form
    {
        ...
        private void Start()
        {
            try
            {
                ...
                simplifyServer.LogNet = new Communication.LogNet.LogNetSingle( Application.StartupPath + @"\Logs\log.txt" );
        ...
        private void userButton2_Click( object sender, EventArgs e )
        {
            ...
            using (FormInputAlien form = new FormInputAlien( ))
            {
                ...
                {
                    OperateResult connect = simplifyServer.ConnectAlientClient( form.IpAddress, form.Port, form.DTU );
