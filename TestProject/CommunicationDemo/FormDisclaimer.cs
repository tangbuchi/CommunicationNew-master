...
namespace CommunicationDemo
{
    public partial class FormDisclaimer : Form
    {
        ...
        {
            NetSimplifyClient simplifyClient = new Communication.Enthernet.NetSimplifyClient("127.0.0.1", 5000);
            Communication.OperateResult<Communication.NetHandle, string> read = simplifyClient.ReadCustomerFromServer(1000, Communication.BasicFramework.SoftBasic.FrameworkVersion.ToString());
