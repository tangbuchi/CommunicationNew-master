    ...
    public partial class FormSerialDebug : Form
    {
            ...
            Invoke( new Action( ( ) =>
             {
                 ...
                 {
                     msg = Communication.BasicFramework.SoftBasic.ByteToHexString( buffer, ' ' );
                 }
                 else
                 {
        ...
        private void button3_Click( object sender, EventArgs e )
        {
            ...
            if(checkBox2.Checked)
            {
                try
                {
                    send = Communication.Serial.SoftCRC16.CRC16( send, Convert.ToByte( textBox3.Text, 16 ), Convert.ToByte( textBox4.Text, 16 ) );
                }
                catch
                {
            ...
            if(checkBox3.Checked)
            {
                ...
                {
                    textBox6.AppendText( Communication.BasicFramework.SoftBasic.ByteToHexString( send, ' ' ) + Environment.NewLine );
                }
            }
