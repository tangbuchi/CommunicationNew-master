...
using Communication;
using Communication.Instrument.Temperature;
    ...
    public partial class FormDAM3601 : Form
    {
        ...
        private void ComboBox2_SelectedIndexChanged( object sender, EventArgs e )
        {
            if (dAM3601 != null)
            {
                ...
                {
                    case 0: dAM3601.DataFormat = Communication.Core.DataFormat.ABCD; break;
                    case 1: dAM3601.DataFormat = Communication.Core.DataFormat.BADC; break;
                    case 2: dAM3601.DataFormat = Communication.Core.DataFormat.CDAB; break;
                    case 3: dAM3601.DataFormat = Communication.Core.DataFormat.DCBA; break;
                    default: break;
                }
            }
        }
