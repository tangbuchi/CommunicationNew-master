...
namespace CommunicationDemo.Redis
{
    public partial class RedisBrowser : Form
    {
        ...
        private void treeView1_AfterSelect( object sender, TreeViewEventArgs e )
        {
            ...
            if (e.Node.ImageKey == "Enum_582")
            {
                ...
                label4.Text = "Size: " + Communication.BasicFramework.SoftBasic.GetSizeDescription( Encoding.UTF8.GetBytes( read.Content ).Length );
                if (read.IsSuccess)
                {
            ...
            else if (e.Node.ImageKey == "brackets_Square_16xMD")
            {
                ...
                label13.Text = "Size: " + Communication.BasicFramework.SoftBasic.GetSizeDescription( size );
        ...
        private void dataGridView1_CellClick( object sender, DataGridViewCellEventArgs e )
        {
            if (e.RowIndex >= 0)
            {
                if (dataGridView1.SelectedRows.Count > 0)
                {
                    ...
                    label9.Text = "Size: " + Communication.BasicFramework.SoftBasic.GetSizeDescription( Encoding.UTF8.GetBytes( textBox7.Text ).Length );
                }
            }
        }
