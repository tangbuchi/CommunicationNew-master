...
namespace CommunicationDemo.Algorithms
{
    public partial class FourierTransform : Form
    {
        ...
        private void Squarewave( )
        {
            ...
            double[] trans = Communication.Algorithms.Fourier.FFTHelper.FFT( data );
        ...
        private void userButton1_Click( object sender, EventArgs e )
        {
            ...
            using (FormImage form = new FormImage( Communication.Algorithms.Fourier.FFTHelper.GetFFTImage( data, 1000, 600, Color.Blue ) ))
            {
                form.ShowDialog( );
            }
