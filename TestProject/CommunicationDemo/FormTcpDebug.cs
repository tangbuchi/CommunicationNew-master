    ...
    public partial class FormTcpDebug : Form
    {
        ...
        private void button3_Click( object sender, EventArgs e )
        {
            ...
            if (checkBox3.Checked)
            {
                ...
                if (checkBox4.Checked)
                {
                    textBox6.AppendText( "[" + DateTime.Now.ToString( "yyyy-MM-dd HH:mm:ss.fff" ) + (Program.Language == 1 ? "][发]   " : "][S]   ") + Communication.BasicFramework.SoftBasic.ByteToHexString( send, ' ' ) + Environment.NewLine );
                }
                else
                {
                    textBox6.AppendText( (Program.Language == 1 ? "][发]   " : "][S]   ") + Communication.BasicFramework.SoftBasic.ByteToHexString( send, ' ' ) + Environment.NewLine );
                }
            }
            try
            {
        ...
        {
            Communication.Robot.EFORT.ER7BC10 eR7BC10 = new Communication.Robot.EFORT.ER7BC10( "192.168.0.100",8008 );
            textBox5.Text = Communication.BasicFramework.SoftBasic.ByteToHexString( eR7BC10.GetReadCommand( ), ' ' );
        }
    }
}
