...
namespace CommunicationDemo
{
    public partial class FormOmron : Form
    {
        public FormOmron( )
        {
            ...
            // omronFinsNet.LogNet = new Communication.LogNet.LogNetSingle( "omron.log.txt" );
        }
        ...
        private void button1_Click( object sender, EventArgs e )
        {
            ...
            omronFinsNet.ByteTransform.DataFormat = (Communication.Core.DataFormat)comboBox1.SelectedItem;
        ...
        {
            OperateResult<byte[]> read = omronFinsNet.ReadFromCoreServer( Communication.BasicFramework.SoftBasic.HexStringToBytes( textBox13.Text ) );
            if (read.IsSuccess)
            {
