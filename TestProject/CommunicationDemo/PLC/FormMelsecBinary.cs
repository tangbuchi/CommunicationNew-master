...
namespace CommunicationDemo
{
    public partial class FormMelsecBinary : Form
    {
        ...
        private void test6( )
        {
            ...
            melsec_net.LogNet = new Communication.LogNet.LogNetSingle( Application.StartupPath + "\\Logs.txt" );
    ...
    public class UserType : Communication.IDataTransfer
    {
        #region IDataTransfer

        private Communication.Core.IByteTransform ByteTransform = new Communication.Core.RegularByteTransform();
