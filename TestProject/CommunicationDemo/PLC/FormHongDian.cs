...
{
    public partial class FormHongDian : Form
    {
        public FormHongDian(SiemensPLCS siemensPLCS)
        {
            InitializeComponent();
        ...
        {
            OperateResult<byte[]> read = siemensTcpNet.ReadFromCoreServer(Communication.BasicFramework.SoftBasic.HexStringToBytes(textBox13.Text));
            if (read.IsSuccess)
            {
