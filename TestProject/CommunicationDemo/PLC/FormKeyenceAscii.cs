...
namespace CommunicationDemo
{
    public partial class FormKeyenceAscii : Form
    {
        ...
        {
            OperateResult<byte[]> read = keyence_net.ReadFromCoreServer( Communication.BasicFramework.SoftBasic.HexStringToBytes( textBox13.Text ) );
            if (read.IsSuccess)
            {
        ...
        private void test6()
        {
            ...
            keyence_net.LogNet = new Communication.LogNet.LogNetSingle( Application.StartupPath + "\\Logs.txt" );
        }
