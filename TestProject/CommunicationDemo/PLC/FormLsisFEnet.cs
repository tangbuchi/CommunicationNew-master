...
using Communication.Profinet.LSIS;
...
namespace CommunicationDemo
{
    public partial class FormLsisFEnet : Form
    {
        ...
        {
                OperateResult<byte[]> read = fastEnet.ReadFromCoreServer( Communication.BasicFramework.SoftBasic.HexStringToBytes( textBox13.Text ) );
                if (read.IsSuccess)
                {
