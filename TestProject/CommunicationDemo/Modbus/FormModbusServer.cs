    ...
    public partial class FormModbusServer : Form
    {
        ...
        private void FormSiemens_Load( object sender, EventArgs e )
        {
            ...
            if(Program.Language == 2)
            {
                ...
                label11.Text = "This server is not a strict S7 protocol and only supports perfect communication with components.";
        ...
        private void ComboBox2_SelectedIndexChanged( object sender, EventArgs e )
        {
            if (busTcpServer != null)
            {
                ...
                {
                    case 0: busTcpServer.DataFormat = Communication.Core.DataFormat.ABCD; break;
                    case 1: busTcpServer.DataFormat = Communication.Core.DataFormat.BADC; break;
                    case 2: busTcpServer.DataFormat = Communication.Core.DataFormat.CDAB; break;
                    case 3: busTcpServer.DataFormat = Communication.Core.DataFormat.DCBA; break;
                    default: break;
                }
            }
        }
